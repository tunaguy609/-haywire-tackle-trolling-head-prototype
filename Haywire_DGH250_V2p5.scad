//
// Haywire Tackle DGH-250 Rev B - Version 2.5 INTEGRATED
// Smooth Elongated Bullet Fishing Lure
// Proper recessed eyes, visible spigot with attached collar and ribs
//
...
difference()
{
    ...
    // Recessed eye sockets - both sides (PROPERLY RECESSED INTO BODY)
    eye_socket(1);
    eye_socket(-1);
}
...
//----------------------------
// Recessed Eye Sockets (both sides, PROPERLY CUT INTO BODY)
//----------------------------
