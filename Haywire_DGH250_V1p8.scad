//
// Haywire Tackle DGH-250 Trolling Head - Version 1.8
// Traditional Rounded Bullet Trolling Head
// Specifications: 1.0" + 15mm extended body, 6mm tip radius, 3mm tip length, pronounced domed tip with seamless blend
//
...
tipLength = 3.0;           // Reduced from 8mm to 3mm
