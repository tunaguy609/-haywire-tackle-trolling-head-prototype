//
// Haywire Tackle DGH-250 Trolling Head - Version 1.11
...
// Skirt Pocket: 0.500" ID (12.70mm), 0.500" depth (12.70mm), 0.125" wall (3.18mm)
//
...
skirtPocketID = 12.70;     // Inside diameter (0.500")
skirtPocketRadius = skirtPocketID / 2;  // 6.35 mm
