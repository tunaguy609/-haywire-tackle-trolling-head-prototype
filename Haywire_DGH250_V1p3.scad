//
// Haywire Tackle DGH-250 Trolling Head - Version 1.3
// Traditional Rounded Bullet Trolling Head
// Specifications: 1.0" total length, 5mm tip diameter, smooth domed bullet profile, two grooves, constant rear body
//
...
tipDiameter = 5.0;         // 5 mm (increased from 3.18 mm)
