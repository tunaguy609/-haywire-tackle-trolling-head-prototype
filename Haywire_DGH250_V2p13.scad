//
// Haywire Tackle DGH-250 Rev B - Version 2.13 SKIRT POCKET RESIZE
// Smooth Elongated Bullet Fishing Lure with Skirt Pocket
// Updated: Skirt pocket diameter changed to 0.75 inches (19.05mm)
//
...
skirtPocketDia = 19.05;    // 0.75" (UPDATED)
